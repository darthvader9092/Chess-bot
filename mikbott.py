...
def main():
    ...
    def insert_move_into_db(move, time_taken):
        cursor = db_connection.cursor()
        cursor.execute("INSERT INTO moves (move, time_taken) VALUES (?, ?)", (move, time_taken))
    ...
    def play_game():
        ...
        if not chess_game.board.is_game_over():
            ...
            insert_move_into_db(str(human_move), time_taken)
        ...
        if not chess_game.board.is_game_over():
            ...
            insert_move_into_db(str(mikhal_move), 0)  # Bot doesn't take time
