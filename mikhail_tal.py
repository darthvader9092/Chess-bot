...
class ChessGameGUI:
    def __init__(self, root):
        ...
        self.selected_square = None  # To store the selected square
        self.update_board()
        ...
        for row in range(8):
            for col in range(8):
                ...
                if self.selected_square == (row, col):
                    color = "blue"  # Change color of selected square to blue
    ...
    def on_board_click(self, event):
        ...
        clicked_square = (event.y // row_size, event.x // col_size)  # Adjusted coordinates

        if self.selected_square == clicked_square:
            # Double-click on the same square, move the piece
